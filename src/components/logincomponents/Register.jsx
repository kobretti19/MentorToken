...
export default function Register() {
  ...
  return (
    <div className="flex flex-col items-start justify-start gap-y-8 bg-white lg:w-3/5 w-full h-max lg:rounded-l-3xl pt-20 px-10 lg:px-48 py-20">
      ...
      <div className="flex flex-row justify-center items-center text-sm w-full bg-stone-100 rounded-r-md">
        <button className="text-white  bg-[#696cff] px-2 py-2 w-full rounded-md hover:bg-opacity-90 easy-in-out transition-all easy-in-out hover:scale-105">
          Startup
        </button>
        <button className="text-[#566a7f]  bg-tranparent px-2 py-2 w-full  hover:bg-opacity-90 easy-in-out transition-all easy-in-out hover:scale-110">
          Mentor
        </button>
      </div>
